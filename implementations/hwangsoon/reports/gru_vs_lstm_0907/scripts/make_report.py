...
ours = json.loads((SCR / "ours_results.json").read_text(encoding="utf-8"))
jin_own = {r["run"]: r for r in json.loads((SCR / "jin_ckpt_scores.json").read_text(encoding="utf-8"))}
jin_ours = {r["run"]: r for r in json.loads((SCR / "jin_on_ours_scores.json").read_text(encoding="utf-8"))}
...
bench = json.loads((SCR / "bench_infer.json").read_text(encoding="utf-8"))
