...
팀원은 `JIN` 브랜치의 수집 프로그램을 받아 자신의 브랜치에서 데이터를 수집하고, 자기 NPZ 파일만 제출합니다. 촬영 자세와 라벨별 동작은 [제스처 수집 안내](README.md)를 따릅니다. 프로젝트 전체 구조는 [루트 README](../README.md)를 확인하세요.

> 아래 목표 개수는 최초 수집 시점 기준입니다. 현재 수집 현황과 추가로 필요한 라벨은 담당자에게 확인하세요.
...
구체적인 촬영 순서, 키 조작, 이동량 경고의 의미는 [촬영 안내](README.md)를 확인하세요.
